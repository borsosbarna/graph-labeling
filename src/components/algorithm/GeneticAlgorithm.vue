  ...
  <div>
    ...
    <div class="md-layout">
      <div class="md-layout-item md-size-33 padded">
        ...
        <md-field>
          <label>Populations Count</label>
          <md-input v-model="parameters.populationsCount" type="number" :disabled="isRunning" />
        </md-field>

        <md-field>
          <label>Population Size</label>
          <md-input v-model="parameters.populationSize" type="number" :disabled="isRunning" />
        </md-field>

        <md-field>
          <label>Mutation Chance</label>
          <md-input v-model="parameters.mutationChance" type="number" :disabled="isRunning" />
        </md-field>

        <md-field>
          <label>Elites Count</label>
          <md-input v-model="parameters.elitesCount" type="number" :disabled="isRunning" />
        </md-field>

        <md-field>
          <label>Max. Generations</label>
          <md-input v-model="parameters.maxGenerations" type="number" :disabled="isRunning" />
        </md-field>
  ...
  methods: {
    ...
    start() {
      ...
      const payload = {
        ...
        populationsCount: parseInt(this.parameters.populationsCount, 10),
        populationSize: parseInt(this.parameters.populationSize, 10),
        mutationChance: parseFloat(this.parameters.mutationChance, 10),
        elitesCount: parseInt(this.parameters.elitesCount, 10),
        maxGenerations: parseInt(this.parameters.maxGenerations, 10),
        maxTime: parseInt(this.parameters.maxTime, 10),
      };

      fetch('localhost:8080/api/ga', {
        method: 'POST',
